...
double motor_speed = 180;

int left_motor_speed;
int right_motor_speed;
//Thiết lập tốc độ rẽ, lùi
int banh_chinh = 175;//-135-100-110.0-90-100
...
{  
    ...
    if (error >3000 and error <2000) {
      ...
      while (error != 2500); // can xac dinh error khi queo
    }
    else {
    motor_speed = 185;
